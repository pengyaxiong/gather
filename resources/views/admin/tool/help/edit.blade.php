    ...
    <div class="admin-content">
        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <form class="am-form" action="{{ route('tool.help.update', $help->id) }}" method="post">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <input type="text" class="am-input-sm" name="title" value="{{$help->title}}">
                        </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-10 am-u-end col-end">
                            <textarea rows="4" name="description">{{$help->description}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-10 am-u-end col-end">
                            <script id="container" name="markdown_html_code"
                                    type="text/plain">{!! $help->markdown_html_code !!}</script>
                        </div>
                    </div>
